...
router.get('/',async (ctx)=>{
     ctx.cookies.set('userinfor','66666',{
        // maxAge:60*60*1000,//有效时长
        // expires:new Date('2021-8-12'), //过期时间
        path:'/news',//限制可以获取cookie的地址
        // domain:'',//域名 正常情况下不需要设置
        httpOnly:true//表示只有服务器端能够用访问
    })
